...
function Input({
  ...
  return (
    <InputPrimitive
      ...
      className={cn(
        "h-11 min-h-11 w-full min-w-0 rounded-lg border border-input bg-card px-3 py-1 text-base font-medium text-foreground transition-colors outline-none placeholder:font-normal placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
